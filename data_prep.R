#!/usr/bin/env Rscript
# Source: https://github.com/allisonhorst/palmerpenguins/blob/master/data-raw/penguins.R
# Modified by: Gavin Masterson 
# 16 December 2021
...
write_csv(penguins_df, here::here("data/penguins.csv"))